...
mondata SPECIES_NOCTOWL, "Noctowl"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FLYING, EGG_GROUP_FLYING
    abilities ABILITY_LEVITATE, ABILITY_MAGIC_BOUNCE
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
...
mondata SPECIES_URSARING, "Ursaring"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 2, 1, 1, 1, 1, 1
    items ITEM_LIFE_ORB, ITEM_SITRUS_BERRY
    genderratio 127
    eggcycles 20
    basefriendship 70
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_FLYGON, "Flygon"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_BUG, EGG_GROUP_DRAGON
    abilities ABILITY_ARENA_TRAP, ABILITY_LEVITATE
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_ZANGOOSE, "Zangoose"
    ...
    growthrate GROWTH_ERRATIC
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_GUTS, ABILITY_POISON_HEAL
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
